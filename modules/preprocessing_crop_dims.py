#preprocessing_crop_dims.py

import cv2
import numpy as np

def preprocess_data(cropped_img, crop_dims = [400,520,1000,1300], canny_min = 125, canny_max = 150, 
    ...
    gray_cropped = gray[crop_dims[0]:crop_dims[1], crop_dims[2]:crop_dims[3]]
    img_cropped  =  img[crop_dims[0]:crop_dims[1], crop_dims[2]:crop_dims[3]]
