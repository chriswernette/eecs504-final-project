...
def street_sign_mask(img):
    ...
    green_lower_limit = np.array([50, 100, 80]) 
    ...
    #Combine Masks
    mask_tmp1 = cv2.bitwise_or(mask_green,mask_blue)
    mask_tmp2 = cv2.bitwise_or(mask_orange,mask_yellow)
    mask = cv2.bitwise_or(mask_tmp1, mask_tmp2)
